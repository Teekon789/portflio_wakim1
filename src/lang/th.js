const textTH = {
  ...
  projects_name: {
    ...
    title2: "blogapp ",
    desc2: "เว็บบล็อกสำหรับโพสต์บทความและแสดงความคิดเห็น สร้างด้วย nextjs และใช้ฐานข้อมูล MongoDB ในการจัดเก็บข้อมูล ใช้ next-auth ในการจัดการการเข้าสู่ระบบและการลงทะเบียนผู้ใช้และมี dashboard สำหรับผู้ดูแลระบบในการจัดการโพสต์และความคิดเห็น มี admin panel สำหรับผู้ดูแลระบบในการจัดการโพสต์และผู้ใช้งาน",
  },
